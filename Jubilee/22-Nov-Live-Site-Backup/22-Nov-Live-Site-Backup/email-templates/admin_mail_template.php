                    ...
                    <tr>
                        <td>
                            <table width="720" cellpadding="0" cellspacing="0" border="0" align="center" class="main_table" style="table-layout:fixed;">
                                ...
                                <tr>
                                    <td style="font-family: ' Quattrocento', serif; font-size: 25px; line-height: 44px; color: #ffff !important; text-align:center;">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="center">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="table-layout:fixed; background: #1C262E">
                                ...
                                <?php endif;
                                if (isset($previousName) && !empty($previousName)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                            Previous Name:
                                ...
                                <?php endif;
                                if (isset($numChildren) && !empty($numChildren)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                            Number of Children:
                                ...
                                <?php endif;
                                if (isset($moveInDate) && !empty($moveInDate)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                            Move In Date:
                                ...
                                <?php endif;
                                if (isset($previousPostcode) && !empty($previousPostcode)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                            Previous Postcode:
                                ...
                                <?php endif;
                                if (isset($previousAddress) && !empty($previousAddress)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                            Previous Address:
                                ...
                                <?php endif;
                                if (isset($prevMoveInDate) && !empty($prevMoveInDate)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                ...
                                <?php endif;
                                if (isset($niNumber) && !empty($niNumber)) :
                                ?>
                                    <tr>
                                        <td style="font-family: ' Quattrocento', serif; font-size: 16px; margin: 0; line-height: 20px;  color:#fff!important; font-weight: 600;">
                                ...
                                <?php endif;
                                if (isset($marriageDate) && !empty($marriageDate)) :
                                ?>
                                ...
                                <?php endif;
                                if (isset($spouseName) && !empty($spouseName)) :
                                ?>
